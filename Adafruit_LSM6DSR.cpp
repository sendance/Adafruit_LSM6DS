...
#include "Adafruit_LSM6DSR.h"

/*!
 *    @brief  Instantiates a new LSM6DS3TRC class
 */
Adafruit_LSM6DSR::Adafruit_LSM6DSR(void) {}

bool Adafruit_LSM6DSR::_init(int32_t sensor_id)
{
  // make sure we're talking to the right chip
  if (chipID() != LSM6DSR_CHIP_ID)
  {
    return false;
  }
...
*/
/**************************************************************************/
void Adafruit_LSM6DSR::enablePedometer(bool enable)
{
...
*/
void Adafruit_LSM6DSR::enableI2CMasterPullups(bool enable_pullups)
{
  Adafruit_BusIO_Register master_config = Adafruit_BusIO_Register(
      i2c_dev, spi_dev, ADDRBIT8_HIGH_TOREAD, LSM6DSR_MASTER_CONFIG);
